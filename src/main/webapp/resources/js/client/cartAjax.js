...
function changeQuanity(id,value,price)
	{
		$.ajax({
			type: "GET",		
			url: "http://localhost:8080/beauteshop/api/gio-hang/changSanPhamQuanity?id="+id+"&value="+value,
...
function deleteFromCart(id)
{
	$.ajax({
		type: "GET",		
		url: "http://localhost:8080/beauteshop/api/gio-hang/deleteFromCart?id="+id,
		success: function(result){
