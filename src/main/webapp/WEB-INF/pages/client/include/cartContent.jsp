...
<tr class="cart_line" id="item${sanpham.id}">
		<div>
		<td>${loop.index+1}</td>
		<td><img src="/beauteshop/img/${sanpham.id}.png" style="width: 150px" class="cart-img"></td>
...
<tr>
		...
		&nbsp;  &nbsp;  &nbsp;  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
		<a class="btn btn-warning " href="<%=request.getContextPath()%>/checkout"><span class="glyphicon glyphicon-check"></span> Xác nhận</a>
		</td>
		</c:if>
